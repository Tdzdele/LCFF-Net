...
__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "v10Detect", "Detect_LDESCD_Head"
...
class LDESCD_DEConv_GN(DEConv):
    def __init__(self, dim):
        super().__init__(dim)
        self.bn = nn.GroupNorm(16, dim)
        
class Detect_LDESCD_Head(nn.Module):
    dynamic = False
    export = False
    shape = None
    ...
    def __init__(self, nc=80, hidc=256, ch=()):
        ...
        self.share_conv = nn.Sequential(Conv_GN(hidc, hidc, 3), LDESCD_DEConv_GN(hidc), Conv_GN(hidc, hidc, 3))
